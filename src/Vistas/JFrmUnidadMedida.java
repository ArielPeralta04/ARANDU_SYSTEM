 ...
 * @author armando
 */
public class JFrmUnidadMedida extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form JFrmUnidadMedida
     */
    public JFrmUnidadMedida() {
        setTitle("JFrmUnidadMedida");
        initComponents();
        cargar();
    }
    ...
    public void guardar(String accion) {
        ...
        switch (accion) {
            case "NUEVO":
                ...
                if (simbolo.isEmpty()) {
                    error += "NO PUEDE DEJAR EL CAMPO DE SIMBOLO VACIO.\n";
                }

                if (error.isEmpty()) {
                    um.setIdunidad(id);
                    um.setDescripcion(descripcion);
                    um.setSimbolo(simbolo);
                    dao.agregar(um);
                    cargar();
                } else {
    ...
    public void recuperarDatos() {
        ...
        if (fila >= 0) {
            ...
            String simbolo = tablaDatos.getValueAt(fila, 2).toString();
    ...
    private void initComponents() {
        ...
        txtSimbolo = new org.jdesktop.swingx.JXTextField();
        ...
        jLabel1.setText("Mantenimiento de Unidades de Medidas");
        ...
        txtSimbolo.setEnabled(false);
        txtSimbolo.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        txtSimbolo.setPrompt("Simbolo...");
            ...
            .addGroup(pestanhaABMLayout.createSequentialGroup()
                ...
                .addGroup(pestanhaABMLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pestanhaABMLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtSimbolo, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(385, 385, 385))
                    .addGroup(pestanhaABMLayout.createSequentialGroup()
    ...
    private void txtSimboloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSimboloActionPerformed
        if (txtSimbolo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "NO PUEDE DEJAR EL CAMPO DE SIMBOLO VACIO", "ADVERTENCIA", JOptionPane.WARNING_MESSAGE);
        } else {
            btnConfirmar.grabFocus();
        }
    ...
    private void txtSimboloKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSimboloKeyTyped
        ...
        if (txtSimbolo.getText().length() == 5) {
            evt.consume();
        }
    ...
    private org.jdesktop.swingx.JXTextField txtSimbolo;
