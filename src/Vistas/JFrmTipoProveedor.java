 ...
 * @author armando
 */
public class JFrmTipoProveedor extends javax.swing.JInternalFrame {

    TipoProveedor tp = new TipoProveedor();
    DAOTipoProveedor dao = new DAOTipoProveedor();
    ...
    /**
     * Creates new form JFrmTipoProveedor
     */
    public JFrmTipoProveedor() {
        setTitle("JFrmTipoProveedor");
        initComponents();
        cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento de Tipos de Proveedor");
