 ...
 * @author armando
 */
public class JFrmTipoTarjeta extends javax.swing.JInternalFrame {

    TipoTarjeta tt = new TipoTarjeta();
    DAOTipoTarjeta dao = new DAOTipoTarjeta();
    ...
    /**
     * Creates new form JFrmTipoTarjeta
     */
    public JFrmTipoTarjeta() {
        setTitle("JFrmTipoTarjeta");
        initComponents();
        cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento de Tipos de Tarjetas");
