 ...
 * @author armando
 */
public class JFrmEmpresa extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form JFrmEmpresa
     */
    public JFrmEmpresa() {
        setTitle("JFrmEmpresa");
        initComponents();
        cargar();
    }
        ...
        switch (accion) {
            case "NUEVO":
                if (razonsocial.isEmpty()) {
                    error += "NO PUEDE DEJAR EL CAMPO DE RAZÓN SOCIAL VACIO.\n";
                }
                if (ruc.isEmpty()) {
    ...
    public void recuperarDatos() {
        ...
        if (fila >= 0) {
            ...
            String razonsocial = tablaDatos.getValueAt(fila, 1).toString();
            String ruc = tablaDatos.getValueAt(fila, 2).toString();
            String telefono = tablaDatos.getValueAt(fila, 3).toString();
            String direccion = tablaDatos.getValueAt(fila, 4).toString();
    ...
    private void initComponents() {
        ...
        txtRazonSocial.setPrompt("Razón social o descripción de la empresa...");
        ...
        txtRuc.setPrompt("Ruc de la empresa...");
        ...
        txtTelefono.setPrompt("Teléfono de la empresa...");
        ...
        txtDireccion.setPrompt("Dirección de la empresa...");
