 ...
 * @author armando
 */
public class JFrmTipoComprobante extends javax.swing.JInternalFrame {

    TipoComprobante tc = new TipoComprobante();
    DAOTipoComprobante dao = new DAOTipoComprobante();
    ...
    /**
     * Creates new form JFrmTipoComprobante
     */
    public JFrmTipoComprobante() {
        setTitle("JFrmTipoComprobante");
        initComponents();
        cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento de Tipos de Comprobantes");
