...
CREATE TABLE IF NOT EXISTS `articulo` (
  ...
  `codigoalfanumerico` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `codigobarra` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `ruc` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
  `telefono` varchar(25) COLLATE utf8_spanish_ci DEFAULT NULL,
  `direccion` varchar(250) COLLATE utf8_spanish_ci DEFAULT NULL,
...
-- Volcando datos para la tabla as.programa: ~23 rows (aproximadamente)
...
REPLACE INTO `usuario` (`idusuario`, `nombre`, `apellido`, `cedula`, `telefono`, `direccion`, `alias`, `clave`, `idempresa`, `idsucursal`) VALUES
	(1, 'ARMANDO ARIEL', 'PERALTA MARTINEZ', '5955455', '0975489075', 'BARRIO SAN JORGE - EX CAMPO 9', 'APERALTA', '5404020b38b9781beecc454cd67ba5b7', 1, 1),
...
CREATE TABLE IF NOT EXISTS `usuario_programa` (
  ...
  CONSTRAINT `FK_USUARIO_PROGRAMA_PROGRAMA` FOREIGN KEY (`idprograma`) REFERENCES `programa` (`idprograma`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_USUARIO_PROGRAMA_USUARIO` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
