...
CREATE TABLE IF NOT EXISTS `articulo` (
  ...
  `codigoalfanumerico` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `codigobarra` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `estado` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tipo_movimiento` (
  ...
  `descripcion` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `abreviacion` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `idtipo` int NOT NULL,
